...
- 🇬🇧 [OverTheWire](https://overthewire.org/) : la plateforme possède plusieurs catégories de challenges et notamment des challenges d'exploitation de binaires. Ils ont également un [serveur Discord](https://overthewire.org/information/chat.html) ;
